...
/*
 * IFormFile projemize bir dosya yüklemek için kulanılan yöntemdir, 
 * HttpRequest ile gönderilen bir dosyayı temsil eder. 
 * FileStream, Stream ana soyut sınıfı kullanılarak genişletilmiş, 
 * belirtilen kaynak dosyalar üzerinde okuma/yazma/atlama gibi 
 * operasyonları yapmamıza yardımcı olan bir sınıftır
 */